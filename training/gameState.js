...
class GameState {
    ...
    evalState(wH, wV, wD, wLP, wLA) {
        ...
        for (let column = 0; column < this.grid.length - 3; column++) {
            for (let row = 0; row < this.grid[column].length; row++) {
                ...
                sum += this.evalLine(counterActive, counterPrev, wLP, wLA) * wH;
            }
        }
        ...
        for (let column = 0; column < this.grid.length; column++) {
            for (let row = 0; row < this.grid[column].length - 3; row++) {
                ...
                sum += this.evalLine(counterActive, counterPrev, wLP, wLA) * wV;
            }
        }
        ...
        for (let column = 0; column < this.grid.length - 3; column++) {
            for (let row = 0; row < this.grid[column].length - 3; row++) {
                ...
                sum += this.evalLine(counterActive, counterPrev, wLP, wLA) * wD;
            }
        }
     ...
     */
    evalLine(counterActive, counterPrev, wLP, wLA) {
